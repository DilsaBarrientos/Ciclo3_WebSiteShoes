...
function checkDir(direccion) {
    var letraespecial = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789#-";
...
function checkContrasena(valor) {
    ...
    if (valor.length < 8 || valor.search(/[a-z]/) < 0 || valor.search(/[A-Z]/) < 0 || valor.search(/[0-9]/) < 0 || valor.length == 0) {
...
module.exports = {checkNombre,checkGenero,checkTelefono,checkDir,checkCorreo,checkContrasena};
